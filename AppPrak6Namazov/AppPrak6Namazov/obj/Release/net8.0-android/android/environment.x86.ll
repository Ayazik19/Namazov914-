...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 539791436, ; hash 0x202c904c, from name: aot-AppPrak6Namazov.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1205836393, ; hash 0x47df9a69, from name: AppPrak6Namazov.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppPrak6Namazov.dll.so
		ptr null; void* handle (0x0)
	}, ; 125
	...
	%struct.DSOCacheEntry {
		i64 1585157929, ; hash 0x5e7b9729, from name: AppPrak6Namazov
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppPrak6Namazov.dll.so
		ptr null; void* handle (0x0)
	}, ; 167
	...
	%struct.DSOCacheEntry {
		i64 3181093749, ; hash 0xbd9ba375, from name: aot-AppPrak6Namazov
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppPrak6Namazov.dll.so
		ptr null; void* handle (0x0)
	}, ; 367
	...
	%struct.DSOCacheEntry {
		i64 3382001935, ; hash 0xc995410f, from name: libaot-AppPrak6Namazov.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppPrak6Namazov.dll.so
		ptr null; void* handle (0x0)
	}, ; 385
	...
	%struct.DSOCacheEntry {
		i64 3396978848, ; hash 0xca79c8a0, from name: libaot-AppPrak6Namazov
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppPrak6Namazov.dll.so
		ptr null; void* handle (0x0)
	}, ; 388
