...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 1489532314788711432, ; hash 0x14abe1bf98724c08, from name: libaot-AppPrak6Namazov
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppPrak6Namazov.dll.so
		ptr null; void* handle (0x0)
	}, ; 33
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 2228139451263574798, ; hash 0x1eebf1069699630e, from name: aot-AppPrak6Namazov
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppPrak6Namazov.dll.so
		ptr null; void* handle (0x0)
	}, ; 53
	...
	%struct.DSOCacheEntry {
		i64 8384492329445064821, ; hash 0x745bb359c68f8075, from name: libaot-AppPrak6Namazov.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppPrak6Namazov.dll.so
		ptr null; void* handle (0x0)
	}, ; 202
	...
	%struct.DSOCacheEntry {
		i64 14688557750965049185, ; hash 0xcbd83d7381151761, from name: AppPrak6Namazov
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppPrak6Namazov.dll.so
		ptr null; void* handle (0x0)
	}, ; 380
	...
	%struct.DSOCacheEntry {
		i64 16637385687816724847, ; hash 0xe6e3de22697be16f, from name: aot-AppPrak6Namazov.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppPrak6Namazov.dll.so
		ptr null; void* handle (0x0)
	}, ; 430
	...
	%struct.DSOCacheEntry {
		i64 17454084955063166947, ; hash 0xf2395dca7a07a7e3, from name: AppPrak6Namazov.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppPrak6Namazov.dll.so
		ptr null; void* handle (0x0)
	}, ; 450
...
@.env.3 = private unnamed_addr constant [37 x i8] c"d7d9add0-0810-44ff-92b3-a4e54292a8ff\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [32 x i8] c"com.companyname.appprak6namazov\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [30 x i8] c"libaot-AppPrak6Namazov.dll.so\00", align 16
